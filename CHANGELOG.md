...
* `StateMachineUtils.verify` no longer requires a second argument to declare the base type of the state machine. This is now
  inferred from the first argument.`

### Added

* `StateMachineUtils.mermaid` is a new utility that will generate mermaid diagram from your state machine.
